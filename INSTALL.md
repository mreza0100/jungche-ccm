...
[v0.61.1 LLM upgrade runbook](releases/v0.61.1.md#llm-upgrade-runbook). Installations already on
`v0.60.1` or later use `pfm update --to v0.61.1`; `v0.60.0` or earlier must bootstrap the
checksum-verified v0.61.1 binary directly because the older updater cannot validate its own
replacement safely.
