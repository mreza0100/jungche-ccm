...
- **the framework bus** — the framework repo's release flow regenerates + publishes the blueprint; installs re-derive from the updated clone.
...
See `SETUP.md` § "Staying current" for user-facing docs.
