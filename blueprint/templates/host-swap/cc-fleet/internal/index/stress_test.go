...
const (
	indexStressEnv       = "CC_FLEET_STRESS"
	indexStressHelperEnv = "CC_FLEET_INDEX_STRESS_HELPER"
	indexStressResultEnv = "CC_FLEET_INDEX_STRESS_RESULT"
	indexStressGiantEnv  = "CC_FLEET_INDEX_STRESS_GIANT"
...
func TestIndexStress(t *testing.T) {
	if os.Getenv(indexStressEnv) != "1" {
		t.Skip("set CC_FLEET_STRESS=1 to run the index stress battery")
	}
