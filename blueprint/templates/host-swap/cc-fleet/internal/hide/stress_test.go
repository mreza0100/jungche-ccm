...
const (
	hideStressHelperEnv = "CC_FLEET_HIDE_STRESS_HELPER"
	hideStressIndexEnv  = "CC_FLEET_HIDE_STRESS_INDEX"
	hideStressReadyEnv  = "CC_FLEET_HIDE_STRESS_READY"
	hideStressGateEnv   = "CC_FLEET_HIDE_STRESS_GATE"
