---
# Generated by .claude/scripts/build-opencode.mjs from .claude/commands/pcm/release.md; do not edit — edit the source, then re-run: node .claude/scripts/build-opencode.mjs
