...
description: "The registered Git writer — no other subagent runs git WRITES here. Phases: SETUP, COMMIT, MERGE, PUSH, PULL, TAG. Code waves work in isolated worktrees and land on main only after their fenced gates pass."
mode: subagent
permission:
  bash:
    "git *": allow
