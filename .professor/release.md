...
_(empty — v0.71.0 shipped every pending bullet. DELETE this line when you append the next bullet: `/pfm:release` copies this list verbatim, so a marker left above a real bullet ships into the release notes.)_
