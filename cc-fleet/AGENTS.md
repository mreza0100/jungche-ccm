<!-- Generated by .claude/scripts/build-codex.mjs from cc-fleet/CLAUDE.md; do not edit — edit the source, then re-run: node .claude/scripts/build-codex.mjs -->
# cc-fleet
...
`cmd/cc-fleet/` holds dispatch (`main.go`, `commands.go`, `pipeline.go`) and the end-to-end jail tests. Subcommands today: `ls hidden hide unhide index resolve inject run open last revive ask headless stream transcript watch status whoami mcp doctor legacy internal version help`.
