...
- **`/clear` auto-hide** — clearing a Claude chat hides the finished session; if that transcript is resumed and speaks again, it becomes visible automatically. `/exit` remains a plain exit.
