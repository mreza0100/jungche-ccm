...
This project runs two AI runtimes as a team. Full protocol: `docs/commands/ptm/references/codex-protocol.md`
...
- Guarded files: PreToolUse hooks gate `.claude/**` + every `CLAUDE.md` (route: `/ptm`) and `{AI_PROJECT}/knowledge/**` (route: `/km`); the deny message carries the unlock steps
