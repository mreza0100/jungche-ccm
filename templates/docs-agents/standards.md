...
> **Ownership:** owned by `/ptm`. New standards land here through `/ptm`, never through a
> pipeline. A pipeline that discovers a missing standard reports it; the user invokes `/ptm`
