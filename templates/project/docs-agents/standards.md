...
> **Ownership:** owned by `/pfm`. New standards land here through `/pfm`, never through a
> pipeline. A pipeline that discovers a missing standard reports it; the user invokes `/pfm`
