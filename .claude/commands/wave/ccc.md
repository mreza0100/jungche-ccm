...
3. **Dispatch** — instructions travel through the orchestrating seat, never to the builder directly; git writes only via `gitter`; guarded files (`.claude/**`, any `CLAUDE.md`, `templates/**`) via `/ptm`.
